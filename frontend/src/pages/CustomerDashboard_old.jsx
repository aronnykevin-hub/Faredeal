...
import { useCustomerRole } from '../contexts/CustomerRoleContext';
import CustomerRoleIndicator from '../components/CustomerRoleIndicator';
...
const CustomerDashboard = ({ defaultTab = 'overview' }) => {
